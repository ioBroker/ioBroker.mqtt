...
exports.findIdForTopic = findIdForTopic;
exports.parseSharedTopic = parseSharedTopic;
 ...
 */
function findIdForTopic(topic, states, prefix, namespace, removePrefix) {
    if (!topic) {
        return undefined;
    }
 ...
 */
function parseSharedTopic(topic) {
